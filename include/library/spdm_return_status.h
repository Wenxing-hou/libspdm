...
#define LIBSPDM_STATUS_UNSUPPORTED_CAP19 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00013)
#define LIBSPDM_STATUS_UNSUPPORTED_CAP20 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00014)
#define LIBSPDM_STATUS_UNSUPPORTED_CAP21 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00015)
#define LIBSPDM_STATUS_UNSUPPORTED_CAP22 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00016)
#define LIBSPDM_STATUS_UNSUPPORTED_CAP23 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00017)
#define LIBSPDM_STATUS_UNSUPPORTED_CAP24 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00018)
#define LIBSPDM_STATUS_UNSUPPORTED_CAP25 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00019)
#define LIBSPDM_STATUS_UNSUPPORTED_CAP26 \
    LIBSPDM_STATUS_CONSTRUCT(LIBSPDM_SEVERITY_ERROR, LIBSPDM_SOURCE_CORE, 0x00020)
